...
**
** $Id: decoder.c,v 1.2 2010/08/01 00:52:26 davelasker Exp $
**/

//This file is derived from faad2 file decoder.c
                              ...
                              unsigned long sample_buffer_size)
{
...
#endif
        aacgain_raw_data_block(hDecoder, hInfo, &ld, &hDecoder->pce, hDecoder->drc);
#ifdef DRM
    }
#endif
    ...
    if (!theGainData->analyze) return NULL;
